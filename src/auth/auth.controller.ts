...
export class AuthController {
  ...
  @ApiResponse({
    status: 201,
    description: 'OTP was sent to the donor phone number.',
  })
  ...
  @ApiResponse({
    status: 201,
    description: 'OTP was sent to the beneficiary phone number.',
  })
  @ApiResponse({ status: 400, description: 'Invalid request body.' })
  async registerBeneficiary(
    ...
    registerBeneficiaryDto.personalPhoto = toPublicUploadPath(personalPhoto);
    registerBeneficiaryDto.familyStatement =
      toPublicUploadPath(familyStatement);
  ...
  @ApiResponse({
    status: 200,
    description: 'OTP was sent to the user phone number.',
  })
  @ApiResponse({ status: 400, description: 'Invalid request body.' })
  @ApiResponse({
    status: 403,
    description: 'Beneficiary account is not approved.',
  })
