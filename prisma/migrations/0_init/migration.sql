...
CREATE TABLE `User` (
    ...
    `countryName` VARCHAR(10) NOT NULL DEFAULT 'syria',
    `countryCode` VARCHAR(191) NOT NULL DEFAULT '+963',
    ...
    UNIQUE INDEX `User_countryCode_number_key`(`countryCode`, `number`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `Orphan` (
    ...
    `currentAddress` JSON NOT NULL,
    `previousAddress` JSON NOT NULL,
    `talent` JSON NOT NULL,
    `isSupported` BOOLEAN NOT NULL DEFAULT false,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    UNIQUE INDEX `Orphan_firstName_lastName_guardianName_key`(`firstName`(50), `lastName`(50), `guardianName`(50)),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `RequestAid` (
    ...
    `withdrawalRequested` BOOLEAN NOT NULL DEFAULT false,
    `withdrawalRequestedAt` DATETIME(3) NULL,
    `withdrawalReason` JSON NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `AidDetails` (
    ...
    `typeAid` ENUM('FOOD_BASKET', 'BABY_MILK', 'MEDICINE_INSURANCE', 'SURGERY', 'MEDICAL_DEVICES') NULL,
...
CREATE TABLE `Transaction` (
    ...
    `type` ENUM('DIRECT_DONATION', 'WALLET_DONATION') NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
